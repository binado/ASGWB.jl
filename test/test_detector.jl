...
# Reference arrays from GWFast (see Python `asgwb` / repo `asgbw`:
# `tests/fixtures/gwfast_orf_reference.npz`, generated by
# `scripts/generate_orf_fixtures.py`). Vendored copy: `orf_gwfast_reference.npz`.
# Regenerate or refresh with: `cp "$ASGWB_PY_REPO/tests/fixtures/gwfast_orf_reference.npz"
# test/fixtures/orf_gwfast_reference.npz"` where `ASGWB_PY_REPO` defaults to
# `~/work/research/phd/asgbw`.
