"""
    AstroSGWBInferenceFlexiChainsExt

netCDF-write helpers for `AstroSGWBInference`, loaded when `FlexiChains` is.
...
"""
module AstroSGWBInferenceFlexiChainsExt
...
function AstroSGWBInference.merge_into_posterior(
...
function AstroSGWBInference.rename_posterior_for_netcdf(chain::FlexiChain)
